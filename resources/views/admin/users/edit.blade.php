    ...
    <div class="row">
        <div class="col-12">
            <form action="{{ route('user.update', $user) }}" enctype="multipart/form-data" method="POST">
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-lg-6 pt-3">
                                    ...
                                    <input id="skills_title_1" type="text" name="skills_title_1" class="form-control" value="{{ old('skills_title_1', $user->skills_title_1) }}" placeholder="Technical Skills">
                                ...
                                <div class="col-lg-6 pt-3">
                                    ...
                                    <input id="skills_title_2" type="text" name="skills_title_2" class="form-control" value="{{ old('skills_title_2', $user->skills_title_2) }}" placeholder="Professional Skills">
                ...
                @csrf
                @method('PUT')
                <button type="submit" class="btn btn-success my-5">Guardar Cambios</button>
            </form>
        </div>
    </div>

    <section class="row p-4 mt-5">
        <div class="col-12">
                ...
                <div class="tab-pane fade show active" id="technical-skills" role="tabpanel" aria-labelledby="technical-skills-tab">
                    <div class="d-flex align-items-start">
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab-1" role="tablist" aria-orientation="vertical">
                            <button class="nav-link active mt-3 mb-1" id="v-pills-new-1-tab" data-bs-toggle="pill" data-bs-target="#v-pills-new-1" type="button" role="tab" aria-controls="v-pills-new-1" aria-selected="true">Agregar Habilidad</button>
                ...
                <div class="tab-pane fade" id="professional-skills" role="tabpanel" aria-labelledby="professional-skills-tab">
                    <div class="d-flex align-items-start">
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab-4" role="tablist" aria-orientation="vertical">
                            <button class="nav-link active mt-3 mb-1" id="v-pills-new-4-tab" data-bs-toggle="pill" data-bs-target="#v-pills-new-4" type="button" role="tab" aria-controls="v-pills-new-4" aria-selected="true">Agregar Habilidad</button>
                            @if (count($user->skills)>0)
                ...
                <div class="tab-pane fade" id="social" role="tabpanel" aria-labelledby="social-tab">
                    <div class="d-flex align-items-start">
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab-2" role="tablist" aria-orientation="vertical">
                            ...
                            <button class="nav-link active mt-3 mb-1" id="v-pills-edit-2-tab" data-bs-toggle="pill" data-bs-target="#v-pills-edit-2" type="button" role="tab" aria-controls="v-pills-edit-2" aria-selected="true" disabled>Editar Redes Sociales</button>
                ...
                <div class="tab-pane fade" id="activities" role="tabpanel" aria-labelledby="activities-tab">
                    <div class="d-flex align-items-start">
                        <div class="nav flex-column nav-pills me-3" id="v-pills-tab-3" role="tablist" aria-orientation="vertical">
                            <button class="nav-link active mt-3 mb-1" id="v-pills-new-2-tab" data-bs-toggle="pill" data-bs-target="#v-pills-new-2" type="button" role="tab" aria-controls="v-pills-new-2" aria-selected="true">Agregar Actividad</button>
