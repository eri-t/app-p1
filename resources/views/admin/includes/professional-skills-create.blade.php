<form action="{{ route('skill.store') }}" method="POST">
    ...
    <div class="row mt-3" style="max-width:950px;">
        ...
        <div class="col d-flex flex-column justify-content-center">
            <div class="row">
                <div class="col-12">
                    <label for="percent2" class="form-label">
                        Porcentaje
                    </label>
                </div>
            </div>
            <div class="row">
                <div class="col-10 col-sm-11">
                    <input id="percent2" type="range" class="form-range" min="0" max="100" step="1" name="percent" onChange="
                            document.getElementById('rangeval2').innerText=document.getElementById('percent2').value" style="max-width:500px;">
                </div>
